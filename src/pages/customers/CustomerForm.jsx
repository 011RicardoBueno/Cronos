...
import { useCreateCustomer } from '@/hooks/1useCreateCustomer';
    ...
    <form onSubmit={handleSubmit} className="p-6 space-y-4">
      ...
      <div>
        ...
        <input
          ...
          className="w-full bg-brand-surface border border-brand-muted/20 rounded-xl p-3 text-brand-text focus:ring-2 focus:ring-brand-primary/50 outline-none transition-all disabled:opacity-50"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          aria-invalid={errorCode === 'DUPLICATE_CUSTOMER' || errorCode === 'INVALID_PHONE' || !!validationError}
          className={`w-full bg-brand-surface border rounded-xl p-3 text-brand-text focus:ring-2 outline-none transition-all disabled:opacity-50 ${
            (errorCode === 'DUPLICATE_CUSTOMER' || errorCode === 'INVALID_PHONE' || validationError)
              ? 'border-red-300 focus:ring-red-200' 
              : 'border-brand-muted/20 focus:ring-brand-primary/50'
          }`}
        />
      </div>
